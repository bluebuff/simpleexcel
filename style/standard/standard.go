...
func Style(styleMng simpleexcel.StyleManager) {
	...
	// 当符合条件时，数字使用条件样式
	styleMng.Store(simpleexcel.NumberCondition, simpleexcel.NewStyleFunc(numberConditionStyle))
	// 用于小数
	...
	// 当符合条件时，小数使用条件样式
	styleMng.Store(simpleexcel.DecimalsCondition, simpleexcel.NewStyleFunc(decimalsConditionStyle))
	// 用于小计数量
	styleMng.Store(simpleexcel.SubtotalNumber, simpleexcel.NewStyleFunc(subtotalNumberStyle))
	// 当符合条件时，小计金额使用条件样式
	styleMng.Store(simpleexcel.SubtotalNumberCondition, simpleexcel.NewStyleFunc(subtotalNumberConditionStyle))
	// 用于小计金额
	styleMng.Store(simpleexcel.SubtotalDecimals, simpleexcel.NewStyleFunc(subtotalDecimalsStyle))
	// 当符合条件时，小计金额使用条件样式
	styleMng.Store(simpleexcel.SubtotalDecimalsCondition, simpleexcel.NewStyleFunc(subtotalDecimalsCondition))
}
